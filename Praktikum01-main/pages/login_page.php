            ...
            <div class="col-lg-8">
                <div class="card-body py-5 px-md-5">
                        ...
                        <div class="form-outline mb-4">
                            <input type="email" id="form2Example1" name='txtEmail' class="form-control" required autofocus/>
                            <label class="form-label" for="form2Example1">Email address</label>
                        </div>

                        <!-- Password input -->
                        <div class="form-outline mb-4">
                            <input type="password" id="form2Example2" name="txtPassword" class="form-control" required/>
